		...
		for ( @options ) {
			...
			if ( $line =~ $re ) {
				...
				my $object =
					...
					# If it fails, add some sensible information to the call
					# stack.
					catch {
